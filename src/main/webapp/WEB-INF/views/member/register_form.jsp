		...
		<div style="width: 600px; margin: auto;">
			...
			<form id="fo" action="register" method="post">
				<table class="table">
					<tr>
						<th>아이디</th>
						<td><input type="text" id="id" name="id" oninput="chkId()">
					...
					<tr>
						<th>주 소</th>
						<td><input type="text" id="addr1" placeholder="우편번호" readonly
							name="addr"> <input type="button" value="우편번호 찾기"
							onclick="daumPost()"> <br> <input type="text"
							name="addr" id="addr2" placeholder="주 소" readonly> <input
							type="text" name="addr" placeholder="상세주소"></td>
					</tr>
					<tr>
						<td colspan="2" align="right"><input type="button"
							onclick="reg()" value="회원가입"></td>
					</tr>
				</table>
			</form>
		</div>
