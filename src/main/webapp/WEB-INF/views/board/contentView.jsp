...
<body onload="replyData()">
		...
		<div id="first">
			<div style="width: 250px; margin: auto; padding-top: 20px;">
				<form id="frm">
					...
					<b>작성자 : ${loginUser }</b>
					<hr>
					<b>제목</b><br> <input type="text" name="title" id="title"
						size="30">
					<hr>
					<b>내용</b><br>
					<textarea name="content" id="content" rows="5" cols="30"></textarea>
					<hr>
					<input type="button" onclick="rep()" value="확인"> <input
						type="button" onclick="slide_hide()" value="취소">
				</form>
			</div>
		</div>
	</div>
	...
	<div align="center">
		<br>
		<h3 align="center">- C O N T E N T -</h3>
		<br>
		<table class="table table-bordered"
			...
			<tr>
				<th>내용</th>
				<td>${dto.content }</td>
				<th colspan="2"><img width="200px" height="100px"
					src="download?imageFileName=${dto.imageFileName }"></th>
			</tr>
			<tr>
				<td colspan="4"><c:if test="${loginUser == dto.id }">
						<input type="button"
						...
						<input type="button"
							...
							value="수정">
					</c:if> <input type="button" onclick="slideClick()" value="답글"> <input
					type="button" onclick="location.href='boardAllList'" value="돌아가기">
				</td>
			</tr>
